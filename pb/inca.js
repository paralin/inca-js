...
$root.peer = (function() {
    ...
    peer.PeerState = (function() {

        /**
         * Properties of a PeerState.
         * @memberof peer
         * @interface IPeerState
         * @property {inca.INodeMessage|null} [lastObservedMessage] PeerState lastObservedMessage
         */
         ...
         * @constructor
         * @param {peer.IPeerState=} [properties] Properties to set
         */
         ...
         * @member {inca.INodeMessage|null|undefined} lastObservedMessage
         * @memberof peer.PeerState
         * @instance
         */
        PeerState.prototype.lastObservedMessage = null;
         ...
         * @static
         * @param {peer.IPeerState=} [properties] Properties to set
         * @returns {peer.PeerState} PeerState instance
         */
         ...
         * @memberof peer.PeerState
         * @static
         * @param {peer.IPeerState} message PeerState message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        PeerState.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.lastObservedMessage != null && message.hasOwnProperty("lastObservedMessage"))
                $root.inca.NodeMessage.encode(message.lastObservedMessage, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {peer.PeerState} PeerState
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PeerState.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.peer.PeerState();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.lastObservedMessage = $root.inca.NodeMessage.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        PeerState.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.lastObservedMessage != null && message.hasOwnProperty("lastObservedMessage")) {
                var error = $root.inca.NodeMessage.verify(message.lastObservedMessage);
                if (error)
                    return "lastObservedMessage." + error;
            }
            return null;
        };
        ...
        PeerState.fromObject = function fromObject(object) {
            if (object instanceof $root.peer.PeerState)
                return object;
            var message = new $root.peer.PeerState();
            if (object.lastObservedMessage != null) {
                if (typeof object.lastObservedMessage !== "object")
                    throw TypeError(".peer.PeerState.lastObservedMessage: object expected");
                message.lastObservedMessage = $root.inca.NodeMessage.fromObject(object.lastObservedMessage);
            }
            return message;
        };
         ...
         * @memberof peer.PeerState
         * @static
         * @param {peer.PeerState} message PeerState
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        PeerState.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults)
                object.lastObservedMessage = null;
            if (message.lastObservedMessage != null && message.hasOwnProperty("lastObservedMessage"))
                object.lastObservedMessage = $root.inca.NodeMessage.toObject(message.lastObservedMessage, options);
            return object;
        };
