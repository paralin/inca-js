...
import { inca, chain, convergentimmutable, peer } from './inca'
...
export class Block extends inca.Block implements IObject {
  ...
  private header: BlockHeader | null
  ...
  public getHeader(): BlockHeader | null {
    return this.header
  }
...
// PeerState is a peer state object.
export class PeerState extends peer.PeerState implements IObject {
  /* Returns the object type ID.
     * @param message Protobuf object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
  ...
  /* Encodes the specified message.
     ...
     */
  public encode(message: any, writer?: $protobuf.Writer): $protobuf.Writer {
    return peer.PeerState.encode(message, writer)
  }
   ...
   */
  public decode(reader: $protobuf.Reader | Uint8Array, length?: number): IObject {
    return new PeerState(peer.PeerState.decode(reader, length))
  }
}
...
// ChainState is a chain state object.
export class ChainState extends chain.ChainState implements IObject {
  /* Returns the object type ID.
     * @param message Protobuf object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
  public getObjectTypeId(): pbobject.IObjectTypeID {
    return { typeUuid: '/inca/chain-state' }
  }
